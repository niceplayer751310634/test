...
<html>
  <head>
		...
		$(".jian").click(function() {
			...
			if(quantity == 1) {
				if(confirm("您是否真要删除该条目？")) {
					location = "/nice/CartItemServlet?method=batchDelete&cartItemIds=" + id;
				}
			} else {
	...
	function batchDelete() {
		...
		location = "/nice/CartItemServlet?method=batchDelete&cartItemIds=" + cartItemIdArray;
	}
